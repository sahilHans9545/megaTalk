...
const Profile = ({ Data }) => {
  ...
  return (
    <div className="bg-color1 dark:bg-dark-secondary border-color4 border-4 dark:text-white  shadow-xl w-96 h-min-72 fixed top-1/2 left-1/2 translate-y-[-50%] translate-x-[-50%] p-4 pb-10">
